...
export default function Footer() {
  return (
    <footer className="premium-gradient text-white py-20 sm:py-28 px-4 sm:px-6 lg:px-8 border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-14">
          ...
          <div className="md:col-span-2 lg:col-span-1 text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full glass-card flex items-center justify-center hover:bg-[#FFB547] hover:text-[#0f0d1e] transition-all"
              >
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full glass-card flex items-center justify-center hover:bg-[#FFB547] hover:text-[#0f0d1e] transition-all">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 md:col-span-2 lg:col-span-2 text-center sm:text-left">
            <div>
              <h4 className="text-lg font-bold font-serif mb-8 gradient-text">Our Services</h4>
              <ul className="space-y-4 text-[#bdb8d8] font-sans text-sm">
                {['High-Speed Internet', 'In-Home WiFi', 'Starlink Microwave', 'Business Solutions', 'VPN & IP Protection'].map((s) => (
                  <li key={s}>
                    <a href="#" className="hover:text-[#FFB547] transition-colors">{s}</a>
                  </li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-bold font-serif mb-8 gradient-text">Customer Support</h4>
              <ul className="space-y-4 text-[#bdb8d8] font-sans text-sm">
          ...
          <div className="text-center md:text-left lg:col-span-1">
            <h4 className="text-lg font-bold font-serif mb-8 gradient-text">Contact Us</h4>
        ...
        <div className="border-t border-white/10 mt-16 sm:mt-20 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-xs text-[#bdb8d8] font-sans">
            <a href="#" className="hover:text-[#FFB547]">Terms of Service</a>
            <a href="#" className="hover:text-[#FFB547]">Privacy Policy</a>
            <a href="#" className="hover:text-[#FFB547]">Fair Usage Policy</a>
          </div>
        </div>
      </div>
    </footer>
